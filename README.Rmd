...
We also provide vignettes that demonstrate how to fit the models in the first and second simulations, along with the boarding school examples, using the pomp package. These are not built when the package is installed, but are accessible in the vignettes directory of the github repo: \url{https://github.com/fintzij/BDAepimodel/tree/master/inst/pomp_vignettes}. 
