...
gibbs_kernel <- function(epimodel) {
          ...
          proposal["beta"]  <- rgamma(1, 0.003 + suff_stats[1], 10 + suff_stats[2])
...
epimodel <- init_settings(epimodel,
                          niter = 10, # this was set to 250,000 for the paper
                          save_params_every = 1, 
...
epimodel <- init_settings(epimodel,
                          niter = 10, # this was set to 100,000 for the paper
                          save_params_every = 1,
...
```{r, warning = F}
          ...
          runtime  <- as.numeric(epimodel$results$time)
