...
test_that("a subset of keys is generated properly", {
          ...
          expect_equal(generate_keys(.epimodel, inds = 5, lookup = FALSE), "2")
          expect_equal(generate_keys(.epimodel, inds = 6:8, lookup = FALSE), c("1", "1", "1"))
})
...
test_that("all of the keys are generated properly", {
          ...
          expect_equal(generate_keys(.epimodel, lookup = FALSE), as.character(.epimodel$config_mat[1:(.epimodel$.ind_final_config - 1),"I"]))
})


test_that("irm keys are correctly retrieved by lookup", {
          set.seed(52787)
          ...
          expect_equal(generate_keys(.epimodel, inds = 3:5, lookup = TRUE), c("3", "2", "2"))
})